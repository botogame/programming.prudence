...
Бизнес это практичный язык дела не ограничивающий себя рамками одной системы. Чтобы реализовать такое в коде применим совмещение ```типизации``` (мастерства упорядочивания) и ```domain driven design``` (искусства самовыражения). 
...
1. <a href="./Прототипы/Центрированный сайт/README.md">Центрированный сайт</a>
2. <a href="./Прототипы/Резонансный код/README.md">Резонансный код</a>
3. <a href="./Прототипы/Внешний вид программы/README.md">Внешний вид программы</a>