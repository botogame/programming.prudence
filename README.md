...
От понятия дублей кода придётся избавиться, чтобы не нарушить структуру вложенности папок. Если  где то нужен синхрон, то добавляем  два окна редактирования или больше, в зависимости от кол-ва зафиксированного кода для синхрона.
