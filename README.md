...
> - результата, где определяется назначение выходящей информации текстового типа
...
3. <a href="./Прототипы/Разоблачение yii2/README.md">Разоблачение yii2</a>
4. <a href="./Прототипы/Конструктор yii2/README.md">Конструктор yii2</a>
