# Код системного бизнеса

Бизнес это практичный язык дела не ограничивающий себя рамками одной системы. Чтобы такое реализовать в коде применим совмещение ```типизации``` (мастерства упорядочивания) и ```domain driven design``` (искусства самовыражения). 
