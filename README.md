...
Предыдущие апробированные прототипы:
1. <a href="./Программы/centering-site.zip">Центрированный сайт</a>
2. <a href="./Программы/resonant-code.zip">Резонансный код</a>
3. <a href="./Программы/Визуал.zip">Внешний вид программы</a>