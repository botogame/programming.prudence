...
Для виртуализации этой основы применим на текущий момент лучшие инструменты ```типизации``` (мастерства упорядочивания) и ```domain driven design``` (искусства самовыражения). 
