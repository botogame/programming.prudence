...
Бизнес это практичный язык дела не ограничивающий себя рамками одной системы и что главное, сохраняет интерес к деятельности "из поколения к поколению". Возьмём это как лучший вариант основы свободы, и для виртуализации этой основы применим на текущий момент лучшие инструменты ```типизации``` (мастерства упорядочивания) и ```domain driven design``` (искусства самовыражения). 
