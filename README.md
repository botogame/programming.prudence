...
Бизнес это практичный язык дела не ограничивающий себя рамками одной системы и что главное, сохраняет интерес к деятельности "из поколения к поколению". 

Возьмём это как лучший вариант основы свободы. 

Для виртуализации этой основы применим на текущий момент лучшие инструменты:
...
> Гении создают новое и неизведанное.
> 
> Безумцы совмещают всё подряд до кучи.

Мы будем процессы и конструкции создавать вне зависимости друг от друга (зона известности), а за их стыковку (зона неизвестности) будет отвечать логика и ресурсы. План и версии станут презентабельной частью кода (и одновременно сводными данными проекта).

### *МАССИВЫ:*

Типизация очень любит свободу и без массива этого многообразия не собрать. Обратимся к возможностям ассоциаций, чтобы убедиться в необходимости применения слоёв, и переведём компоненты проекта с российского на американский:
...
Здесь две очень разные области виртуальности.
...
1. Металл = Metal
  ...
  1.2. Камень = Stone
    ...
    1.2.2. Вода = Water
 ```
И это пока единственное, что переводится обратно без двух-смысленностей для разных стран, религий и т.п. заблуждениях.
...
>
> - названия
> - варианта [ПЛАН: найти 150 тыс. руб. для доработки рефлексии]
...
[ПЛАН: найти 150 тыс. руб. для доработки рефлексии]
...
3. <a href="./Прототипы/Внешний вид программы/">Внешний вид программы</a>

Текущие задачи:
1) ПЛАН: найти 150 тыс. руб. для доработки рефлексии
