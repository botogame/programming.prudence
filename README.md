...
1. настройка  - подключение к базе данных, таблицы, определение места запуска
2. контроль - ввод данных, стопперы, заглушки
3. реакции - вывод данных
4. компоненты - функциональные программы (настройка+контроль+реакции)
