...
1.2.1.📄Ресурс "январь" = false / сюда данные не нужны
1.2.2.📄Ресурс "февраль" = true / ожидаем сюда данные

1.📁Конструкция "таблица" = select / берём данные
1.2.2.1.📁Конструкция "tinyint" = sort asc / сортируем начиная с малого числа
```
Результат:

```
1.📁Конструкция "таблица" = array / получить результат в виде массива
```
