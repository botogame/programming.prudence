...
От понятия дублей кода придётся избавиться, вместо неё введём доступность с помощью вложенности папок. И если присуствуют дубли закрепим их связями для синхронного редактирования: добавляем  два окна редактирования или больше, в зависимости от кол-ва зафиксированного кода для синхрона. С таким подходом можно будет к дублю применить кастомизацию.
