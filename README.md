...
1. <a href="./Прототипы/Конструктор резонансного кода/README.md">Конструктор резонансного кода</a>
2. <a href="./Прототипы/Резонансный код/README.md">Резонансный код</a>
3. <a href="./Прототипы/Центрированный сайт/README.md">Центрированный сайт</a>
