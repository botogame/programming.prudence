...
Изучаю Carrier Rider Mapper... наверно буду первым кто грамотно это спроектирует на редактировании кода. Это заходишь в редактор и видишь структуру файлов, а внутри подкатегории html, js, css, mysql...
